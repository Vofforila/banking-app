        ...
        <div class="bg-zinc-50 dark:bg-zinc-800 rounded-2xl p-6 border border-zinc-200 dark:border-zinc-700">
            ...
            @else
                ...
                <div class="flex items-center gap-2 mb-4">
                    ...
                    <div class="flex items-center gap-3 mb-2 font-semibold text-zinc-900 dark:text-zinc-100">
                        <x-category-icon :category="$selectedCategory" :size="8"/>
                        <p class="font-semibold">{{ $selectedCategory }} — {{ $selectedPeriod }}</p>
                    </div>
                </div>
